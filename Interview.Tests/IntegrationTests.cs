...
[
  ...
  },
  {
    ...
    ""body"": ""cupiditate quo est a modi nesciunt soluta\nipsa voluptas error itaque dicta in\nautem qui minus magnam et distinctio eum\naccusamus ratione error aut""
        ...
        {
            var postsToInclude = GetRequestedIds();
            return postsToInclude;
        }

        private List<Post> DeriveSuntReportPostList()
        {
            var postsToInclude = GetRequestedIds(new int[] 
                { 1,13,24,29,30,31,32,41,42,45,49,51,53,58,59,60,65,70,91,93,98,17,21,48,55,61 });
            return postsToInclude;
        }
